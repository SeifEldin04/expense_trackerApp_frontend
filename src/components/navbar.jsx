            ...
            <div>
                <MenuButton className=''>
                    <div className='flex items-center gap-1'>
                        <div className='w-10 2xl:w-10 h-5 2xl:h-10 rounded-full text-white bg-violet-600 cursor-pointer flex items-center justify-center'>
        ...
        <div className='w-full flex items-center justify-between py-6'>
            <Link to='/'>
                <div className='flex items-center gap-2 cursor-pointer'>
                    <div className='w-10 md:w-10 h-10 md:h-10 flex items-center justify-center bg-violet-700 rounded-xl'>
                        <RiCurrencyFill className='text-white text-2xl hover:animate-spin' />
                    </div>
